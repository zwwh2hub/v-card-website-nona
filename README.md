...
This repository contains a lightweight HTML/CSS/JS template for a digital business card. All content is plain markup so anyone can edit text, images, or links without a build step.
